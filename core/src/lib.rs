...
pub use softsfi::{
    ...
    unknown_opcode_prog, verify, FlatMem, Insn, Program, SfiError, SfiExec, SfiMem, SidRange,
    SidSandbox, SoftOp, SoftSfiReport, MAX_INSNS, MAX_REGS, SFI_SECRET_B, SFI_SID_A, SFI_SID_B,
    WORD,
};
