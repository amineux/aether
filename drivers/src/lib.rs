...
//! (packed `CpCmd` + Soft SMMU + IRQ/fence). [`IreeShapedCp`] is the
//! partner-shaped HAL spine: an IREE HAL dispatch packet, not Soft-CP 2.0.
//! [`PartnerNpuStub`] remains a documented no-op sketch.
